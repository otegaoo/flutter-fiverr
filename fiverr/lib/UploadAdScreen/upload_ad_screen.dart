...
import 'package:fiverr/DialogBox/loading_dialog.dart';
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            next ? 'Please describe items ' : 'Choose Item Images',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 5.0,),
                TextField(
                  decoration: const InputDecoration(hintText: 'Write Item Description'),
                  onChanged: (value) 
                  {
                    description = value;
                  },
